...
1. **GitHub Security Advisories** (Preferred): [Report via GitHub](https://github.com/LanikSJ/laniksj/security/advisories/new)
2. **Email**: Send details to [security@lanik.us](mailto:security@lanik.us)
3. **Security Discussions**: Open a discussion in our [GitHub Discussions](https://github.com/LanikSJ/laniksj/discussions/categories/security)
4. **Security Issues**: Create a [Security Advisory](https://github.com/LanikSJ/laniksj/security/advisories/new) on GitHub
...
This project contains various utilities and tools. Security considerations include:
...
- **Keep Updated**: Always use the latest version of the tools
...
- Open a discussion in our [GitHub Discussions](https://github.com/LanikSJ/laniksj/discussions)
- Contact the maintainers through the security email above for sensitive matters

Thank you for helping keep laniksj secure!
